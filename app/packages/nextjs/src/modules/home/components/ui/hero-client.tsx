...
export const HeroClient = () => {
  ...
  return (
    <div className="w-full max-w-4xl rounded-2xl border border-border bg-card shadow-2xl overflow-hidden text-left">
      {/* Header bar */}
      ...
      <div className="p-6 md:p-8 font-mono text-xs md:text-sm leading-relaxed space-y-4">
        {activeTab === "memory" && (
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground">
              <span className="text-foreground font-semibold">Integrity Hash:</span> 0xe3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855
            </p>
        ...
        {activeTab === "context" && (
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground">
              <span className="text-foreground font-semibold">Reutilización:</span> Sin duplicación de datos entre agentes.
            </p>
            <div className="p-4 rounded-xl bg-muted/40 border border-border/50 text-foreground font-sans text-xs flex justify-between items-center">
              <div>
