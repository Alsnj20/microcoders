...
export const ServicesGrid = () => {
  const operations = [
    { action: "Crear Agente", cost: "5 MC", detail: "Generación e inicialización del blueprint en IPFS", icon: "add_circle" },
    { action: "Ejecutar Agente", cost: "2 MC", detail: "Procesamiento de inferencia LLM y contextualización", icon: "play_arrow" },
    { action: "Actualizar Agente", cost: "2 MC", detail: "Nueva versión del blueprint registrada on-chain", icon: "update" },
    { action: "Crear Memoria", cost: "1 MC", detail: "Cifrado fuera de cadena e inserción en pgvector", icon: "memory" },
