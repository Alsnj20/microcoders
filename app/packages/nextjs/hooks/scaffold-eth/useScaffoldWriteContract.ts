...
import { type Config, type UseWriteContractParameters, useAccount, useConfig, useWriteContract } from "wagmi";
import { type WriteContractErrorType, type WriteContractReturnType, estimateFeesPerGas } from "wagmi/actions";
...
import type { AllowedChainIds } from "~~/utils/scaffold-stylus";
