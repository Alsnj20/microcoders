        ...
        <div className="flex justify-between items-center h-16 px-6 md:px-12 max-w-7xl mx-auto">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <a href="/memories" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                Memorias
              </a>
              <a href="/agents" className="text-sm font-medium text-foreground border-b-2 border-primary pb-0.5">
                Agentes
              </a>
