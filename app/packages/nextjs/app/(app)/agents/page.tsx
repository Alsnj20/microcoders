        ...
        <aside className="hidden xl:flex w-80 flex-col h-full border-l border-border bg-background overflow-hidden">
          <div className="p-6 border-b border-border">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-1">
                ...
                <Button variant="ghost" size="icon" onClick={handleDelete} title="Archivar">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-5">
            ...
            <div>
              ...
              <p className="text-sm text-foreground">{selectedAgent.description || "Sin descripción"}</p>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Button variant="ghost" size="sm" onClick={() => setShowMemoryLinker(true)}>
            ...
            <div className="pt-3 border-t border-border">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <p className="text-xs text-foreground">{selectedAgent.createdAt}</p>
                </div>
                <div>
                  <p className="text-xs text-muted-foreground">Actualizado</p>
                  <p className="text-xs text-foreground">{selectedAgent.updatedAt}</p>
                </div>
              </div>
            </div>
          </div>
